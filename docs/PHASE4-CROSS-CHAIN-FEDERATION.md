...
| Tier | Stake | Slash % | APY | R/R | Translation | 🐻 Bear Sim (APY×1.5) |
|------|-------|---------|-----|-----|-------------|----------------------|
| 🥉 Bronze | 100 | 50% | 2% | **25:1** | 25 units pain/1% yield | APY→3% · R/R→**16.7:1** ↓ |
| 🥈 Silver | 500 | 40% | 3.5% | **11:1** | 11 units pain/1% yield | APY→5.25% · R/R→**7.6:1** ↓ |
| 🥇 Gold | 2000 | 30% | 5% | **6:1** | 6 units pain/1% yield | APY→7.5% · R/R→**4:1** ↓ |

> **Bear Sim**: Pump APY 1.5x via Karak incentives → R/R drops ~33%, drawing liquidity when needed.  
> **Bull Sim**: Halve APY → R/R doubles, filtering casuals (premium on slots).
...
│                                                                             │
│   ═══════════════════════════════════════════════════════════════════════   │
│   🐻 BEAR MARKET (APY × 1.5 via Karak incentives)                          │
│   ═══════════════════════════════════════════════════════════════════════   │
│                                                                             │
│   BRONZE:  50% ÷ 3%    = 16.7:1  →  33% better hedge! Newbie magnet        │
│   SILVER:  40% ÷ 5.25% =  7.6:1  →  Liquidity lure for mid-tier            │
│   GOLD:    30% ÷ 7.5%  =  4:1    →  🐋 Whale magnet! Best R/R in DeFi      │
│                                                                             │
│   ═══════════════════════════════════════════════════════════════════════   │
│   🐂 BULL MARKET (APY × 0.5 — demand > supply)                             │
│   ═══════════════════════════════════════════════════════════════════════   │
│                                                                             │
│   BRONZE:  50% ÷ 1%    = 50:1   →  Only serious reporters survive          │
│   SILVER:  40% ÷ 1.75% = 23:1   →  Filters casual stakers                  │
│   GOLD:    30% ÷ 2.5%  = 12:1   →  Still best tier, but premium pricing    │
│                                                                             │
│   ═══════════════════════════════════════════════════════════════════════   │
│   FORMULA: New R/R = Slash % ÷ (APY × market_multiplier)                   │
│   ═══════════════════════════════════════════════════════════════════════   │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│                        MARKET-ADAPTIVE FLYWHEEL                             │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│   🐂 BULL MARKET                          🐻 BEAR MARKET                    │
│   ══════════════                          ══════════════                    │
│                                                                             │
│   • High demand for slots                 • Low demand, need liquidity      │
│   • APY × 0.5 (scarce rewards)           • APY × 1.5 (Karak incentives)    │
│   • R/R doubles → filters casuals        • R/R drops 33% → attracts TVL    │
│   • Premium on Gold priority             • Gold becomes whale magnet        │
│   • Protocol profitable                   • Network resilient               │
│                                                                             │
│   ┌─────────┐                             ┌─────────┐                       │
│   │  APY ↓  │                             │  APY ↑  │                       │
│   └────┬────┘                             └────┬────┘                       │
...
> **Why This Matters**: Professional reporters gravitate to Gold because the math compounds—lower slash risk + higher yield = sustainable income stream. Bronze is "tuition" tier where new reporters learn without catastrophic loss. Bear markets make Gold a **whale magnet** with 4:1 R/R.
