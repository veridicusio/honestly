    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Understanding quantum computing and why VERIDICUS uses it</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          {/* Why VERIDICUS Uses It */}
          <div className="p-4 rounded-lg border bg-card">
            <div className="flex items-center space-x-2 mb-3">
              <Zap className="h-5 w-5 text-violet-500" />
              <h3 className="font-medium">Why VERIDICUS Uses Quantum Computing</h3>
            </div>
            <p className="text-sm text-muted-foreground mb-3">
              VERIDICUS leverages quantum computing for:
            </p>
          ...
          <div className="p-4 rounded-lg border bg-card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="p-3 rounded bg-muted">
                ...
                <Badge variant="outline" className="mt-2 text-xs">~10 VDC</Badge>
              </div>
              <div className="p-3 rounded bg-muted">
                ...
                <Badge variant="outline" className="mt-2 text-xs">~5 VDC</Badge>
              </div>
              <div className="p-3 rounded bg-muted">
                ...
                <Badge variant="outline" className="mt-2 text-xs">~20 VDC</Badge>
              </div>
              <div className="p-3 rounded bg-muted">
                ...
                <Badge variant="outline" className="mt-2 text-xs">~50 VDC</Badge>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 rounded-lg border-2 border-primary bg-primary/5">
            ...
            <p className="text-sm text-muted-foreground">
              VERIDICUS makes quantum computing accessible to everyone. Instead of requiring expensive subscriptions or technical expertise, you simply pay with VERIDICUS tokens. This democratizes access to cutting-edge quantum resources, enabling developers, researchers, and businesses to leverage quantum computing without barriers.
            </p>
          </div>
        </CardContent>
      </Card>
