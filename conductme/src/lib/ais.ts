...
export const aiRoster: AIProfile[] = [
  {
    ...
    flair:
      'The meticulous, cautious expert. The "red teamer" who finds the flaws in your plan.',
  ...
  },
  {
    ...
    flair:
      "The versatile, creative powerhouse. Your go-to for brainstorming and synthesis.",
