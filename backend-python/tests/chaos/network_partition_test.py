...
class NetworkPartitionTester:
    ...
    def create_proxy(self, name: str, upstream: str, listen_port: int) -> bool:
        ...
        try:
            ...
            resp = requests.post("http://localhost:8474/proxies", json=proxy_config, timeout=5)
    ...
    def remove_toxic(self, proxy_name: str, toxic_name: str) -> bool:
        ...
        try:
            resp = requests.delete(
                f"http://localhost:8474/proxies/{proxy_name}/toxics/{toxic_name}", timeout=5
            )
    ...
    def test_neo4j_partition(self):
        ...
        try:
            ...
            self.add_toxic(proxy_name, "timeout", {"timeout": 1000})  # 1 second timeout
    ...
    def test_latency_injection(self):
        ...
        try:
            ...
            self.add_toxic(proxy_name, "latency", {"latency": 500, "jitter": 100})  # 500ms
            ...
            _ = req.get(f"{self.base_url}/monitoring/health", timeout=10)
