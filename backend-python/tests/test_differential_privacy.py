...
class TestDifferentialPrivacy:
    ...
    def test_laplace_noise_adds_noise(self):
        ...
        noisy_values = [dp.add_laplace_noise(true_value, sensitivity=1.0) for _ in range(10)]
    ...
    def test_laplace_noise_sensitivity(self):
        ...
        noisy_low_sens = [dp1.add_laplace_noise(true_value, sensitivity=1.0) for _ in range(100)]
        noisy_high_sens = [dp2.add_laplace_noise(true_value, sensitivity=10.0) for _ in range(100)]
    ...
    def test_gaussian_noise_adds_noise(self):
        ...
        noisy_values = [dp.add_gaussian_noise(true_value, sensitivity=1.0) for _ in range(10)]
    ...
    def test_exponential_mechanism_selection(self):
        ...
        selections = [dp.add_exponential_noise(scores, sensitivity=1.0) for _ in range(100)]
...
class TestDifferentialPrivacyEdgeCases:
    ...
    def test_very_large_epsilon(self):
        ...
        noisy_values = [dp.add_laplace_noise(true_value, sensitivity=1.0) for _ in range(20)]
    ...
    def test_attack_scenario_reconstruction(self):
        ...
        true_value = 42.0
        noisy_values = [
            dp.add_laplace_noise(true_value, sensitivity=1.0, epsilon=0.01) for _ in range(10)
        ]
    ...
    def test_gaussian_vs_laplace(self):
        ...
        laplace_values = [dp_laplace.add_laplace_noise(true_value, sensitivity) for _ in range(50)]

        gaussian_values = [
            dp_gaussian.add_gaussian_noise(true_value, sensitivity) for _ in range(50)
        ]
