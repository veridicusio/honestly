  ...
  theme: {
    extend: {
      colors: {
        ...
        // Slate overrides for darker theme
        slate: {
          850: '#141b2d',
          900: '#0f1629',
          950: '#070b14',
      ...
      keyframes: {
        ...
        glow: {
          ...
          '100%': { boxShadow: '0 0 40px rgba(99, 102, 241, 0.6), 0 0 60px rgba(139, 92, 246, 0.3)' },
        },
        aurora: {
